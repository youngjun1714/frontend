...
import MobileArtistFollowerNodata from './MobileArtistFollowerNodata';
...
const MobileArtistFollowers = (props) => {
  ...
  if (users?.length <= 0) {
    return <MobileArtistFollowerNodata onClose={onClose} isMe={isMe} />;
  }
...
export default MobileArtistFollowers;
