...
const GET_TOP_FOLLOWERS = gql`
  query GetTopFollowers {
    getTopFollowers {
      id
      nickname
      isPartner
...
const MobileArtistFollowerNodata = ({ onClose, isMe }) => {
  const { loading, data: followerData } = useQuery(GET_TOP_FOLLOWERS, {
    fetchPolicy: 'cache-and-network',
  });
  const { getTopFollowers: users } = followerData || {};
...
export default MobileArtistFollowerNodata;
